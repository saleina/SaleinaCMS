<template>
    <div class="image-input">
        ...
        <div class="input card">
            ...
            <s-button @click.native="remove" v-if="fileName" class="danger min reverse">Remove Image</s-button>
            <s-button @click.native="showMediaLibrary = true" class="primary min">Pick Image</s-button>
        </div>

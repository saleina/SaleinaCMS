...
If you are using the CMS through a CDN like JsDelivr, then that depends on the version tag you are using. You can find the version tag you are using in the `/admin/index.html` file of your site.
